...
TEST(Json, nominalCase)
{
  ...
  std::string expected{R"({"array":["this","is",1,true,"array","not",null],"bool":true,"nested":{"array":["array in array:",["this","is",1,true,"array","not",null]],"object":true},"null":null,"number":1.5,"number from int":1235,"string":"This is a string"})"};
